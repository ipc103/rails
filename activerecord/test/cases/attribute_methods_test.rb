...
class AttributeMethodsTest < ActiveRecord::TestCase
  ...
  test "#alias_attribute with an overridden original method from a module issues a deprecation" do
    message = <<~MESSAGE.gsub("\n", " ")
    DEPRECATION WARNING: AttributeMethodsTest::ClassWithDeprecatedAliasAttributeBehaviorFromModule uses `alias_attribute :subject, :title`,
  ...
  test "#alias_attribute with enum method raises exception" do
    message = <<~MESSAGE.gsub("\n", " ")
  ...
  test "#alias_attribute with an _in_database method raises exception" do
    message = <<~MESSAGE.gsub("\n", " ")
  ...
  test "#alias_attribute with an association method raises exception" do
    message = <<~MESSAGE.gsub("\n", " ")
